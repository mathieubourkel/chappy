...
import ProjectDisplayCode from "../../Project/ModalDisplayCode.tsx";
import DeleteProject from "../../Project/ModalDeleteProject.tsx";
    ...
    <>
      ...
      >
        <Menu >
          <MenuHandler>
            <Button
              className="text-light-100 bg-marine-300 flex items-center"
              size={"sm"}
            >
              <FontAwesomeIcon icon={faList} className={"text-sm 2xl:mr-3"} />
              <Typography
